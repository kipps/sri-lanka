...
class BreadCrumbs {
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $this->config = array_merge(array(
            ...
            'bcTplCrumbCurrentLink' => '<span itemprop="title">[[+text]]</span>',
            'bcTplCrumbFirst' => '<li class="B_firstCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb">[[+text]]</li>',
            'bcTplCrumbHome' => '<a class="B_homeCrumb" itemprop="url" rel="[[+description]]" href="/"><span itemprop="title">[[+text]]</span></a>',
            'bcTplCrumbLast' => '<li class="B_lastCrumb active" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb">[[+text]]</li>',
            ...
            'bcTplCrumbOuter' => '<ol class="breadcrumb">[[+text]]</ol>',
